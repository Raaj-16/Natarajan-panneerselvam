...
import { FolderGit2, Globe, MessageSquareText, ShoppingCart, ArrowUpRight } from "lucide-react";
...
const PROJECTS = [
  {
    ...
    thumbnail: "https://images.unsplash.com/photo-1460925895917-adf4e565e479?w=600&h=400&fit=crop",
    link: "#",
  },
  {
    id: 2,
    ...
    <section id="projects" className="py-16 md:py-24">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="space-y-6">
          {PROJECTS.map(({ id, title, description, icon: Icon, stack, thumbnail }) => (
            <article
              key={id}
              ...
              <div className="flex flex-col md:flex-row md:gap-6">
                ...
                <div className="flex flex-col justify-between p-5 md:py-6 md:pr-6">
                  <div>
                    ...
                    <p className="mb-4 text-sm text-foreground/70 leading-relaxed">{description}</p>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`transition-transform duration-300 ${hoveredId === id ? 'translate-x-1' : ''}`}>
